...
export const type = {
    ...
    CHANGE_AGENT_ID: `${key}_CHANGE_AGENT_ID`,
...
export const change_agent_id = (value) => ({
    type: type.CHANGE_AGENT_ID,
    value
})

export const change_agent_name = (value) => ({
...
export const on_open = ({provinsi_id, provinsi_name, sector_id, sector_name, agent_id, agent_name}) => {
    return async (dispatch, getState) => { 
        ...
        dispatch(change_agent_id(agent_id))
        dispatch(change_agent_name(agent_name))
    }
}
